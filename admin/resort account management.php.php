        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                        ...
                        <table id="resortTable" class="table datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $row['password']?></td>
                                    <td>
                                        <a data-edit-id="<?= $row['id']?>" class="btn btn-sm btn-primary"><i
                                                class="bi bi-pencil-square"></i></a>
                                        <a data-delete-id="<?= $row['id']?>" class="btn btn-sm btn-danger"><i
                    ...
                    <!-- Edit Modal -->
                    <div class="modal fade" id="EditResortData" data-bs-backdrop="static" data-bs-keyboard="false"
                            ...
                            <div class="modal-content">
                                ...
                                <form action="code.php" method="POST">
                                    <div class="modal-body p-3">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="editResortName"
                                                name="resort_name" placeholder="Resort Name" required>
                                            <label for="editResortName">Resort Name</label>
                                        </div>
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="editResortAddress"
                                                name="resort_address" placeholder="Resort Address" required>
                                            <label for="editResortAddress">Resort Address</label>
                                        </div>
                                        <div class="form-floating mb-3 position-relative">
                                            <input type="password" class="form-control" id="editResortPassword"
                                                name="password" placeholder="Resort Password" required>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-primary" name="EditResort"><i
